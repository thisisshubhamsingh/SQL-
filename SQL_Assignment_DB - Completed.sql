...
VALUES
	(200,'Tom','Cruise', 10, 3000),
    (300,'Hugh','Laurie',20,7500),
    (400,'Tom','Hanks',30,750);      
INSERT INTO employee 
VALUES
	(500,'Johnny','Depp', 20, 1300),
    (600,'Hugh','Grant',30,850),
    (700,'Ben','Affleck',30,75),
    (800,'George','Clooney',10,10000);
INSERT INTO employee 
VALUES
	(900,'Henry',Null, 10, 3000),
...
VALUES 
    ...
    (15,'Ducor','CA',140.86,102.04),
    (910,'Salem','KY',86.98,113.96),
    (612,'Sturdivant','MO',93.84,86.39),
    (537,'Hagatna','GU',97.17,151.81),
    (970,'East','CT',115.68,132.38),
    (510,'Eastlake','MI',134.09,38.78),
    (354,'Larkspur','CA',107.05,65.97),
    (983,'Patriot','IN',82.64,46.08),
    (799,'Corriganville','MD',141.38,153.65),
    (581,'Carlos','MN',114.91,66.28),
    (825,'Addison','MI',96.37,142.41),
    ...
    (430,'Rumsey','KY',70.69,50.21),
    (234,'Rogers','CT',140.47,33.18),
    (700,'Pleasant','AR',135.14,145.59),
    (702,'Everton','MO',119.05,51.49),
    (662,'Skanee','MI',70.17,129.56),
    (171,'Springerville','AZ',124.69,150.66),
    (615,'Libertytown','MD',144.58,111.97),
    (26,'Church','MD',39.43,91.26),
    (692,'Yellow','ID',83.12,150.89),
    (336,'Dumont','MN',57.01,129.37),
    (464,'Gales','CT',104.57,37.41),
    ...
    (199,'Linden','MI',53.41,32.62),
    (453,'Sedgwick','AR',68.93,75.29),
    (451,'Fort','IA',142.86,140.64),
    (950,'Peachtree City','GA',80.49,155.98),
    (326,'Rocheport','MO',114.16,64.48),
    (189,'West','KY',73.97,45.06),
    (638,'Clovis','CA',92.44,138.08),
    (156,'Heyburn','ID',82.09,121.05),
    (861,'Peabody','KS',75.42,152.21),
    (722,'Marion','AL',53.32,31.34),
    ...
    (269,'Jack','AL',49.94,85.63),
    (969,'Dixie','GA',27.22,36.47),
    (271,'Hillside','CO',99.27,68.84),
    (667,'Hawarden','IA',90.96,46.93),
    (350,'Cannonsburg','MI',91.03,120.67),
    (49,'Osborne','KS',70.36,139.71),
    (332,'Elm','LA',45.94,29.40),
    (172,'Atlantic','MI',131.23,99.47),
    (699,'North','CT',37.80,95.27),
    (417,'New','IA',139.96,94.60),
    (99,'Woodstock','CT',117.39,162.63),
    (404,'Farmington','IL',91.71,72.02),
    (23,'Honolulu','HI',110.10,139.74),
    (1,'Pfeifer','KS',37.44,65.68),
    (127,'Oshtemo','MI',100.37,135.95),
    (657,'Gridley','KS',118.15,55.80),
    (261,'Fulton','KY',111.11,51.93),
    (182,'Winter','FL',133.23,32.76),
    (328,'Monroe','LA',28.36,108.42),
    (779,'Del','CA',59.18,95.77),
    (646,'Greens','IN',133.92,135.48),
    (756,'Garden','AL',96.08,105.42),
    (157,'Blue','KY',116.96,162.00),
    (400,'New','IN',134.02,120.95),
    (61,'Brilliant','AL',86.44,159.85),
    (610,'Archie','MO',40.20,28.20),
    (985,'Winslow','AR',126.14,126.12),
    (207,'Olmitz','KS',29.24,38.40),
    (941,'Allerton','IA',61.84,112.50),
    (70,'Norphlet','AR',144.02,61.19),
    (343,'Mechanic','ME',71.67,71.12),
    (531,'North','KY',42.99,141.91),
    (996,'Keyes','CA',76.97,85.61),
    (167,'Equality','AL',106.98,116.06),
    (750,'Neon','KY',101.98,147.67),
    (410,'Calhoun','KY',95.60,56.90),
    (725,'Alpine','AR',116.82,114.65),
    (988,'Mullan','ID',143.30,154.67),
    (55,'Coalgood','KY',57.17,149.02),
    (640,'Walnut','MS',40.94,76.96),
    (302,'Saint','FL',51.71,119.86),
    (387,'Ojai','CA',68.61,119.33),
    (476,'Julian','CA',130.51,101.56),
    (907,'Veedersburg','IN',78.90,94.85),
    (294,'Orange','FL',59.22,137.31),
    (661,'Payson','AZ',126.30,154.16),
    (745,'Windom','KS',114.19,126.39),
    (631,'Urbana','IA',142.53,29.35),
    (356,'Ludlow','CA',110.99,87.59),
    (419,'Lindsay','MT',143.10,67.84),
    (494,'Palatka','FL',94.55,52.33),
    (625,'Bristol','ME',87.97,95.29),
    (459,'Harmony','IN',135.02,70.83),
    (636,'Ukiah','CA',86.98,89.58),
    (106,'Yuma','AZ',111.33,153.95),
    (204,'Alba','MI',91.64,103.63),
    (344,'Zachary','LA',60.71,152.49),
    (599,'Esmond','IL',75.55,90.92),
    (515,'Waresboro','GA',144.25,153.61),
    (497,'Hills','MN',137.97,134.77),
    (162,'Montgomery','MO',70.44,44.67),
    (499,'Delavan','MN',32.58,64.51),
    (362,'Magnolia','MS',112.74,31.80),
    (545,'Byron','CA',136.51,120.42),
    (712,'Dundee','IA',61.60,105.04),
    (257,'Eureka','AR',72.06,34.78),
    (154,'Baker','CA',31.05,148.46),
    (715,'Hyde','MA',65.09,156.24),
    (493,'Groveoak','AL',53.39,87.51),
    (836,'Kenner','LA',91.74,126.57),
    (82,'Many','LA',36.28,94.73),
    (644,'Seward','AK',120.29,35.71),
    (391,'Berryton','KS',60.73,139.76),
    (696,'Chilhowee','MO',79.61,49.36),
    (905,'Newark','IL',72.53,129.89),
    (81,'Cowgill','MO',136.80,27.64),
    (31,'Novinger','MO',108.04,111.91),
    (299,'Goodman','MS',101.44,117.28),
    (84,'Cobalt','CT',87.32,26.53),
    (754,'South','MI',144.66,52.79),
    (144,'Eskridge','KS',107.63,63.49),
    (305,'Bennington','KS',93.87,83.24),
    (226,'Decatur','MS',71.25,117.57),
    (224,'West','MA',58.96,96.01),
    (694,'Ozona','FL',144.99,120.88),
    (623,'Jackson','AL',111.23,67.24),
    (543,'Lapeer','MI',128.62,114.26),
    (819,'Peaks','ME',59.14,110.69),
    ...
    (690,'Ravenden','AR',67.63,108.26),
    (62,'Monroe','AR',131.90,150.22),
    (365,'Payson','IL',81.74,92.11),
    (922,'Kell','IL',70.36,58.74),
    (838,'Strasburg','CO',89.40,47.89),
    (286,'Five','AL',45.66,122.22),
    (968,'Norris','IL',53.67,76.11),
    (928,'Coaling','AL',144.26,52.21),
    (746,'Orange','IA',93.53,162.95),
    (892,'Effingham','KS',132.95,97.72),
    (193,'Corcoran','CA',81.30,139.56),
    (225,'Garden','IA',54.21,119.91),
    (573,'Alton','MO',79.78,112.04),
    (830,'Greenway','AR',119.27,35.99),
    (241,'Woodsboro','MD',76.63,141.89),
    (783,'Strawn','IL',29.68,51.09),
    (675,'Dent','MN',70.75,136.78),
    (270,'Shingletown','CA',61.12,102.10),
    (378,'Clio','IA',46.15,115.42),
    (104,'Yalaha','FL',120.38,119.69),
    (460,'Leakesville','MS',107.17,72.58),
    (804,'Fort','CO',38.50,93.39),
    (53,'Shasta','CA',99.32,155.61),
    (448,'Canton','MN',123.64,151.42),
    (751,'Agency','MO',59.28,95.68),
    (29,'South','KY',58.00,116.96),
    (718,'Taft','CA',107.86,146.74),
    (213,'Calpine','CA',46.51,43.28),
    (624,'Knobel','AR',95.35,62.09),
    (908,'Bullhead','AZ',94.83,30.43),
    (845,'Tina','MO',131.70,28.12),
    (685,'Anthony','KS',45.01,161.13),
    (731,'Emmett','ID',57.10,31.53),
    (311,'South','MN',30.50,87.13),
    (866,'Haverhill','IA',61.83,109.17),
    (598,'Middleboro','MA',108.05,149.29),
    (541,'Siloam','GA',105.02,92.23),
    (889,'Lena','LA',78.16,129.62),
    (654,'Lee','IL',27.67,51.01),
    (841,'Freeport','MI',113.55,50.96),
    (446,'Mid','FL',110.41,50.75),
    (249,'Acme','LA',73.16,67.68),
    (376,'Gorham','KS',111.32,64.75),
    (136,'Bass','ME',137.67,61.33),
...
(
    ...
    CoutryCode VARCHAR(3) DEFAULT NULL,
...
(
    ...
    TextDiscriptionc VARCHAR(4000) DEFAULT NULL,
...
VALUES 
	(103,'Atelier graphique','40.32.2555','Nantes',NULL,'44000','France',1370,21000.00),
    ...
    (124,'Mini Gifts Distributors Ltd.','4155551450','San Rafael','CA','97562','USA',1165,210500.00),
    (125,'Havel & Zbyszek Co','(26) 642-7555','Warszawa',NULL,'01-012','Poland',NULL,0.00),
    (128,'Blauer See Auto, Co.','+49 69 66 90 2555','Frankfurt',NULL,'60528','Germany',1504,59700.00),
    (129,'Mini Wheels Co.','6505555787','San Francisco','CA','94217','USA',1165,64600.00),
    (131,'Land of Toys Inc.','2125557818','NYC','NY','10022','USA',1323,114900.00),
    (141,'Euro+ Shopping Channel','(91) 555 94 44','Madrid',NULL,'28034','Spain',1370,227600.00),
    (144,'Volvo Model Replicas, Co','0921-12 3555','Luleå',NULL,'S-958 22','Sweden',1504,53100.00),
    (145,'Danish Wholesale Imports','31 12 3555','Kobenhavn',NULL,'1734','Denmark',1401,83400.00),
    (146,'Saveley & Henriot, Co.','78.32.5555','Lyon',NULL,'69004','France',1337,123900.00),
    (148,'Dragon Souveniers, Ltd.','+65 221 7555','Singapore',NULL,'079903','Singapore',1621,103800.00),
    (151,'Muscle Machine Inc','2125557413','NYC','NY','10022','USA',1286,138500.00),
    (157,'Diecast Classics Inc.','2155551555','Allentown','PA','70267','USA',1216,100600.00),
    (161,'Technics Stores Inc.','6505556809','Burlingame','CA','94217','USA',1165,84600.00),
    (166,'Handji Gifts& Co','+65 224 1555','Singapore',NULL,'069045','Singapore',1612,97900.00),
    (167,'Herkku Gifts','+47 2267 3215','Bergen',NULL,'N 5804','Norway  ',1504,96800.00),
    (168,'American Souvenirs Inc','2035557845','New Haven','CT','97823','USA',1286,0.00),
    (169,'Porto Imports Co.','(1) 356-5555','Lisboa',NULL,'1756','Portugal',NULL,0.00),
    (171,'Daedalus Designs Imports','20.16.1555','Lille',NULL,'59000','France',1370,82900.00),
    (172,'La Corne Dabondance, Co.','(1) 42.34.2555','Paris',NULL,'75012','France',1337,84300.00),
    (173,'Cambridge Collectables Co.','6175555555','Cambridge','MA','51247','USA',1188,43400.00),
    (175,'Gift Depot Inc.','2035552570','Bridgewater','CT','97562','USA',1323,84300.00),
    (177,'Osaka Souveniers Co.','+81 06 6342 5555','Kita-ku','Osaka',' 530-0003','Japan',1621,81200.00),
    (181,'Vitachrome Inc.','2125551500','NYC','NY','10022','USA',1286,76400.00),
    (186,'Toys of Finland, Co.','90-224 8555','Helsinki',NULL,'21240','Finland',1501,96500.00),
    (187,'AV Stores, Co.','(171) 555-1555','Manchester',NULL,'EC2 5NT','UK',1501,136800.00),
    (189,'Clover Collections, Co.','+353 1862 1555','Dublin',NULL,'2','Ireland',1504,69400.00),
    (198,'Auto-Moto Classics Inc.','6175558428','Brickhaven','MA','58339','USA',1216,23000.00),
    (201,'UK Collectables, Ltd.','(171) 555-2282','Liverpool',NULL,'WX1 6LT','UK',1501,92700.00),
    (202,'Canadian Gift Exchange Network','(604) 555-3392','Vancouver','BC','V3F 2K1','Canada',1323,90300.00),
    (204,'Online Mini Collectables','6175557555','Brickhaven','MA','58339','USA',1188,68700.00),
    (205,'Toys4GrownUps.com','6265557265','Pasadena','CA','90003','USA',1166,90700.00),
    (206,'Asian Shopping Network, Co','+612 9411 1555','Singapore',NULL,'038988','Singapore',NULL,0.00),
    (209,'Mini Caravy','88.60.1555','Strasbourg',NULL,'67000','France',1370,53800.00),
    (211,'King Kong Collectables, Co.','+852 2251 1555','Central Hong Kong',NULL,NULL,'Hong Kong',1621,58600.00),
    (216,'Enaco Distributors','(93) 203 4555','Barcelona',NULL,'08022','Spain',1702,60300.00),
    (219,'Boards & Toys Co.','3105552373','Glendale','CA','92561','USA',1166,11000.00),
    (223,'Natürlich Autos','0372-555188','Cunewalde',NULL,'01307','Germany',NULL,0.00),
    (227,'Heintze Collectables','86 21 3555','Århus',NULL,'8200','Denmark',1401,120800.00),
    (233,'Québec Home Shopping Network','(514) 555-8054','Montréal','Québec','H1J 1C3','Canada',1286,48700.00),
    (237,'ANG Resellers','(91) 745 6555','Madrid',NULL,'28001','Spain',NULL,0.00),
    (239,'Collectable Mini Designs Co.','7605558146','San Diego','CA','91217','USA',1166,105000.00),
    (240,'giftsbymail.co.uk','(198) 555-8888','Cowes','Isle of Wight','PO31 7PJ','UK',1501,93900.00),
    (242,'Alpha Cognac','61.77.6555','Toulouse',NULL,'31000','France',1370,61100.00),
    (247,'Messner Shopping Network','069-0555984','Frankfurt',NULL,'60528','Germany',NULL,0.00),
    (249,'Amica Models & Co.','011-4988555','Torino',NULL,'10100','Italy',1401,113000.00),
    (250,'Lyon Souveniers','+33 1 46 62 7555','Paris',NULL,'75508','France',1337,68100.00),
    (256,'Auto Associés & Cie.','30.59.8555','Versailles',NULL,'78000','France',1370,77900.00),
    (259,'Toms Spezialitäten, Ltd','0221-5554327','Köln',NULL,'50739','Germany',1504,120400.00),
    (260,'Royal Canadian Collectables, Ltd.','(604) 555-4555','Tsawassen','BC','T2F 8M4','Canada',1323,89600.00),
    (273,'Franken Gifts, Co','089-0877555','München',NULL,'80805','Germany',NULL,0.00),
    (276,'Anna\'s Decorations, Ltd','02 9936 8555','North Sydney','NSW','2060','Australia',1611,107800.00),
    (278,'Rovelli Gifts','035-640555','Bergamo',NULL,'24100','Italy',1401,119600.00),
    (282,'Souveniers And Things Co.','+61 2 9495 8555','Chatswood','NSW','2067','Australia',1611,93300.00),
    (286,'Marta\'s Replicas Co.','6175558555','Cambridge','MA','51247','USA',1216,123700.00),
    (293,'BG&E Collectables','+41 26 425 50 01','Fribourg',NULL,'1700','Switzerland',NULL,0.00),
    (298,'Vida Sport, Ltd','0897-034555','Genève',NULL,'1203','Switzerland',1702,141300.00),
    (299,'Norway Gifts By Mail, Co.','+47 2212 1555','Oslo',NULL,'N 0106','Norway  ',1504,95100.00),
    (303,'Schuyler Imports','+31 20 491 9555','Amsterdam',NULL,'1043 GR','Netherlands',NULL,0.00),
    (307,'Der Hund Imports','030-0074555','Berlin',NULL,'12209','Germany',NULL,0.00),
    (311,'Oulu Toy Supplies, Inc.','981-443655','Oulu',NULL,'90110','Finland',1501,90500.00),
    (314,'Petit Auto','(02) 5554 67','Bruxelles',NULL,'B-1180','Belgium',1401,79900.00),
    (319,'Mini Classics','9145554562','White Plains','NY','24067','USA',1323,102700.00),
    (320,'Mini Creations Ltd.','5085559555','New Bedford','MA','50553','USA',1188,94500.00),
    (321,'Corporate Gift Ideas Co.','6505551386','San Francisco','CA','94217','USA',1165,105000.00),
    (323,'Down Under Souveniers, Inc','+64 9 312 5555','Auckland  ',NULL,NULL,'New Zealand',1612,88000.00),
    (324,'Stylish Desk Decors, Co.','(171) 555-0297','London',NULL,'WX3 6FW','UK',1501,77000.00),
    (328,'Tekni Collectables Inc.','2015559350','Newark','NJ','94019','USA',1323,43000.00),
    (333,'Australian Gift Network, Co','61-7-3844-6555','South Brisbane','Queensland','4101','Australia',1611,51600.00),
    (334,'Suominen Souveniers','+358 9 8045 555','Espoo',NULL,'FIN-02271','Finland',1501,98800.00),
    (335,'Cramer Spezialitäten, Ltd','0555-09555','Brandenburg',NULL,'14776','Germany',NULL,0.00),
    (339,'Classic Gift Ideas, Inc','2155554695','Philadelphia','PA','71270','USA',1188,81100.00),
    (344,'CAF Imports','+34 913 728 555','Madrid',NULL,'28023','Spain',1702,59600.00),
    (347,'Men \'R\' US Retailers, Ltd.','2155554369','Los Angeles','CA','91003','USA',1166,57700.00),
    (348,'Asian Treasures, Inc.','2967 555','Cork','Co. Cork',NULL,'Ireland',NULL,0.00),
    (350,'Marseille Mini Autos','91.24.4555','Marseille',NULL,'13008','France',1337,65000.00),
    (353,'Reims Collectables','26.47.1555','Reims',NULL,'51100','France',1337,81100.00),
    (356,'SAR Distributors, Co','+27 21 550 3555','Hatfield','Pretoria','0028','South Africa',NULL,0.00),
    (357,'GiftsForHim.com','64-9-3763555','Auckland',NULL,NULL,'New Zealand',1612,77700.00),
    (361,'Kommission Auto','0251-555259','Münster',NULL,'44087','Germany',NULL,0.00),
    (362,'Gifts4AllAges.com','6175559555','Boston','MA','51003','USA',1216,41900.00),
    (363,'Online Diecast Creations Co.','6035558647','Nashua','NH','62005','USA',1216,114200.00),
    (369,'Lisboa Souveniers, Inc','(1) 354-2555','Lisboa',NULL,'1675','Portugal',NULL,0.00),
    (376,'Precious Collectables','0452-076555','Bern',NULL,'3012','Switzerland',1702,0.00),
    (379,'Collectables For Less Inc.','6175558555','Brickhaven','MA','58339','USA',1188,70700.00),
    (381,'Royale Belge','(071) 23 67 2555','Charleroi',NULL,'B-6000','Belgium',1401,23500.00),
    (382,'Salzburg Collectables','6562-9555','Salzburg',NULL,'5020','Austria',1401,71700.00),
    (385,'Cruz & Sons Co.','+63 2 555 3587','Makati City',NULL,'1227 MM','Philippines',1621,81500.00),
    (386,'L\'ordine Souveniers','0522-556555','Reggio Emilia',NULL,'42100','Italy',1401,121400.00),
    (398,'Tokyo Collectables, Ltd','+81 3 3584 0555','Minato-ku','Tokyo','106-0032','Japan',1621,94400.00),
    (406,'Auto Canal+ Petit','(1) 47.55.6555','Paris',NULL,'75016','France',1337,95000.00),
    (409,'Stuttgart Collectable Exchange','0711-555361','Stuttgart',NULL,'70563','Germany',NULL,0.00),
    (412,'Extreme Desk Decorations, Ltd','04 499 9555','Wellington',NULL,NULL,'New Zealand',1612,86800.00),
    (415,'Bavarian Collectables Imports, Co.',' +49 89 61 08 9555','Munich',NULL,'80686','Germany',1504,77000.00),
    (424,'Classic Legends Inc.','2125558493','NYC','NY','10022','USA',1286,67500.00),
    (443,'Feuer Online Stores, Inc','0342-555176','Leipzig',NULL,'04179','Germany',NULL,0.00),
    (447,'Gift Ideas Corp.','2035554407','Glendale','CT','97561','USA',1323,49700.00),
    (448,'Scandinavian Gift Ideas','0695-34 6555','Bräcke',NULL,'S-844 67','Sweden',1504,116400.00),
    (450,'The Sharp Gifts Warehouse','4085553659','San Jose','CA','94217','USA',1165,77600.00),
    (452,'Mini Auto Werke','7675-3555','Graz',NULL,'8010','Austria',1401,45300.00),
    (455,'Super Scale Inc.','2035559545','New Haven','CT','97823','USA',1286,95400.00),
    (456,'Microscale Inc.','2125551957','NYC','NY','10022','USA',1286,39800.00),
    (458,'Corrida Auto Replicas, Ltd','(91) 555 22 82','Madrid',NULL,'28023','Spain',1702,104600.00),
    (459,'Warburg Exchange','0241-039123','Aachen',NULL,'52066','Germany',NULL,0.00),
    (462,'FunGiftIdeas.com','5085552555','New Bedford','MA','50553','USA',1216,85800.00),
    (465,'Anton Designs, Ltd.','+34 913 728555','Madrid',NULL,'28023','Spain',NULL,0.00),
    (471,'Australian Collectables, Ltd','61-9-3844-6555','Glen Waverly','Victoria','3150','Australia',1611,60300.00),
    (473,'Frau da Collezione','+39 022515555','Milan',NULL,NULL,'Italy',1401,34800.00),
    (475,'West Coast Collectables Co.','3105553722','Burbank','CA','94019','USA',1166,55400.00),
    (477,'Mit Vergnügen & Co.','0621-08555','Mannheim',NULL,'68306','Germany',NULL,0.00),
    (480,'Kremlin Collectables, Co.','+7 812 293 0521','Saint Petersburg',NULL,'196143','Russia',NULL,0.00),
    (481,'Raanan Stores, Inc','+ 972 9 959 8555','Herzlia',NULL,'47625','Israel',NULL,0.00),
    (484,'Iberia Gift Imports, Corp.','(95) 555 82 82','Sevilla',NULL,'41101','Spain',1702,65700.00),
    (486,'Motor Mint Distributors Inc.','2155559857','Philadelphia','PA','71270','USA',1323,72600.00),
    (487,'Signal Collectibles Ltd.','4155554312','Brisbane','CA','94217','USA',1165,60300.00),
    (489,'Double Decker Gift Stores, Ltd','(171) 555-7555','London',NULL,'WA1 1DP','UK',1501,43300.00),
    (495,'Diecast Collectables','6175552555','Boston','MA','51003','USA',1188,85100.00),
    (496,'Kelly\'s Gift Shop','+64 9 5555500','Auckland  ',NULL,NULL,'New Zealand',1612,110000.00);
...
VALUES 
    ...
    (10105,'S700_3962',22,99.31,7),(10105,'S72_3212',25,44.77,8),(10106,'S18_1662',36,134.04,12),(10106,'S18_2581',34,81.10,2),
    (10106,'S18_3029',41,80.86,18),(10106,'S18_3856',41,94.22,17),(10106,'S24_1785',28,107.23,4),(10106,'S24_2841',49,65.77,13),
    (10106,'S24_3420',31,55.89,14),(10106,'S24_3949',50,55.96,11),(10106,'S24_4278',26,71.00,3),(10106,'S32_4289',33,65.35,5),
    (10106,'S50_1341',39,35.78,6),(10106,'S700_1691',31,91.34,7),(10106,'S700_2047',30,85.09,16),(10106,'S700_2466',34,99.72,9),
    (10106,'S700_2834',32,113.90,1),(10106,'S700_3167',44,76.00,8),(10106,'S700_4002',48,70.33,10),(10106,'S72_1253',48,43.70,15),
    (10107,'S10_1678',30,81.35,2),(10107,'S10_2016',39,105.86,5),(10107,'S10_4698',27,172.36,4),(10107,'S12_2823',21,122.00,1),
    (10107,'S18_2625',29,52.70,6),(10107,'S24_1578',25,96.92,3),(10107,'S24_2000',38,73.12,7),(10107,'S32_1374',20,88.90,8),
    (10108,'S12_1099',33,165.38,6),(10108,'S12_3380',45,96.30,4),(10108,'S12_3990',39,75.81,7),(10108,'S12_4675',36,107.10,3),
    (10127,'S24_4048',20,107.63,7),(10127,'S32_2509',45,46.53,13),(10127,'S32_3207',29,60.90,6),(10127,'S50_1392',46,111.12,9),
    (10127,'S50_1514',46,55.65,4),(10128,'S18_3140',41,120.20,2),(10128,'S18_3259',41,80.67,4),(10128,'S18_4522',43,77.24,1),
    (10128,'S700_1938',32,72.75,3),(10129,'S10_4757',33,123.76,2),(10129,'S24_2011',45,113.06,9),(10129,'S24_3151',41,81.43,4),
    (10129,'S24_3816',50,76.31,1),(10129,'S700_1138',31,58.67,5),(10129,'S700_2610',45,72.28,3),(10129,'S700_3505',42,90.15,6),
    (10129,'S700_3962',30,94.34,7),(10129,'S72_3212',32,44.23,8),(10130,'S18_3029',40,68.82,2),(10130,'S18_3856',33,99.52,1),
    (10131,'S18_1662',21,141.92,4),(10131,'S24_2841',35,60.97,5),(10131,'S24_3420',29,52.60,6),(10131,'S24_3949',50,54.59,3),
    (10131,'S700_2047',22,76.94,8),(10131,'S700_2466',40,86.76,1),(10131,'S700_4002',26,63.67,2),(10131,'S72_1253',21,40.22,7),
    (10132,'S700_3167',36,80.00,1),(10133,'S18_2581',49,80.26,3),(10133,'S24_1785',41,109.42,5),(10133,'S24_4278',46,61.58,4),
...
ALTER TABLE Product
ADD COLUMN supplier_id INT AFTER description;
ALTER TABLE Product
...
MODIFY COLUMN supplier_name VARCHAR(30) NOT NULL UNIQUE;


/*
	a. Add a column called deptno in emp table.
...
CREATE INDEX index_emp_no ON emp(emp_no);
...
SELECT
    ...
    hire_date,
    salary,
    extract(year from current_date())-extract(year from  hire_date) AS year_diff
FROM
	emp
WHERE salary > 2000
HAVING year_diff <= 3
...
FROM
    ...
    population
FROM city
WHERE population > 100000) AS city;
...
DELIMITER $$
CREATE PROCEDURE order_details( IN par1_YearOrderDate INT , IN par2_MonthOrderDate INT)
...
BEGIN
	SELECT 
		...
		status
	FROM orders
	WHERE YEAR(OrderDate) = par1_YearOrderDate
		AND MONTH(OrderDate) = par2_MonthOrderDate;
END$$

DELIMITER ;

CALL order_details(2005,11);
...
DELIMITER $$
CREATE FUNCTION CustomerLevel (Par_CustomerNumber INT)
RETURNS VARCHAR(10)
DETERMINISTIC
BEGIN
    ...
    FROM 
		payments
	WHERE CustomerNumber = Par_CustomerNumber
	...
	ELSEIF
		(Total_amount >= 25000 AND Total_amount <= 50000)
	THEN
...
SELECT CustomerLevel(103) AS Purchase_status;
SELECT CustomerLevel(144) AS Purchase_status;
SELECT CustomerLevel(112) AS Purchase_status;
...
SELECT 
	A.*,
    CASE
		WHEN Total_amount < 25000 THEN 'Silver'
...
FROM
	...
	GROUP BY p.CustomerNumber) AS A
...
-- ON DELETE CASCADE using triggers
...
DELIMITER $$
CREATE TRIGGER trg_on_delete_cascade 
...
-- ON UPDATE CASCADE using Triggers

DROP TRIGGER IF EXISTS trg_on_update_cascade;

DELIMITER $$
CREATE TRIGGER trg_on_update_cascade
